---
title: Prenatal & Postnatal Brand
type: meta
domain: prenatal
---
...
- **Lifestyle brand with clinical backing** — not pharma-coded ([[prenatal-dtc-lifestyle-strategy]])
- **FSDU regulatory path** — not Health Supplement category ([[prenatal-fsdu-regulatory]])
- **DTC subscription model** — not doctor/pharmacy distribution initially
- **Gynecologist co-founder** — not advisor, not endorser ([[prenatal-gynecologist-cofounder]])
...
- [[prenatal-dtc-lifestyle-strategy]] — lifestyle vs pharma-coded decision
- [[prenatal-launch-roadmap]] — 6-step launch plan
- [[prenatal-contract-manufacturers]] — shortlisted manufacturers with evaluation criteria
- [[prenatal-efficacy-phases]] — phased approach to clinical proof

## Sources

- [[2026-04-13-prenatal-brand-strategy]] — comprehensive strategy document (Aishu's compiled research)

## Market data

- India health & wellness market: $164B (2025) → $258B (2034), 5.14% CAGR
- Global prenatal supplement market: $0.69B (2026) → $1.34B (2034), 8.62% CAGR
- Global postpartum supplement market: $1.35B (2024) → $2.93B (2033), 9.06% CAGR
- Asia-Pacific holds 38.58% of global postpartum market (largest regional share)

## Key risks

- **Pricing sensitivity:** Rs.800-1,500/month is premium for India
- **[[trimacare]] patent:** trimester-specific MMN model must be navigated
- **FSSAI/CDSCO line:** all nutrients must stay within ICMR RDA
- **Consumer education:** Indian women defer to doctors
- **Gynecologist search:** must be co-founder, not just advisor

## Connections

- [[thambu]] — husband, co-founder, also runs [[domains/mindwise/_index|Mindwise]] and [[domains/racesims/_index|RaceSims]]
- [[cdri-08]] — Thambu's existing supplement expertise (different product, same industry knowledge)
