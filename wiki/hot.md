...
- **Davlish (QT-000370):** Updated quote ₹5,49,900 (was ₹7,42,007 in QT-000348). Rigs 4→3, removed Shifter mount, VNM Lite 3 Pedal, dropped Ares 8nm/290 GP/310 Apex. Added CPP Lite 2-pedal + 3-pedal. CPP Apex 3-pedal (×1) is still a blocker — not in PO.
- **Critical shortfalls post-PO:** Ares 12nm −11 (urgent reorder from ENSU), PC tray / Keyboard tray −15 each (fabrication), Triple Monitor stand basic −9 / precision −8 (fabrication), Samsung G5 32" −15 (Star ×6 + PS8 ×12), CPP Apex 2-pedal −3, VNM 3DOF −2 (Garvish blocked, reorder from VNM 30-45 days).
- **Pending quotes (B2B):** Davlish ₹5.5L · Star ₹24.5L · RaceSims Studio ₹28L · Garvish ₹30.7L · INVRSE + PS8 (accessories TBD).
