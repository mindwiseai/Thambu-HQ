...
- **[2026-05-30] Landed-cost rig BOM now locked** — see [[2026-05-30-chennai-landed-cost-bom]]. Sim hardware (Conspit/VNM, incl. tax): **Formula/GT rig ₹1,60,750** (Apex 2-pedal, no clutch) · **Rally/GT rig ₹2,14,750** (VNM 3-pedal + shifter + handbrake). + PC+screens ₹3,23,995 ⇒ **all-in Formula ₹4,84,745 / Rally ₹5,38,745 per rig**. **Motion platform ₹3,70,000** (supplier-quoted) ⇒ motion rig ₹9,08,745. Build mix = **4 Formula + 4 Rally** (one rally = motion). **Fleet equipment ₹44.64L landed**, net capital ₹70.2L. *Note: this is the Conspit/VNM "buy-it-ourselves" baseline; the sponsorship split below would cut it further.*
